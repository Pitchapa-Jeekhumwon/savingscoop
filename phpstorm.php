 ...
 * @property Update_stament_libbraries $update_st                     Update Statement model
 * @property Loan_libraries      $loan_libraries
 * @property Template_libraries  $libraries
 * @property Contract_modal      $contract
 * @property Deposit_modal       $deposit
 * @property Information         $info
 * @property Share_modal         $share
 * @property Guarantee           $guarantee
 * @property Beneficiaries       $beneficiaries
 * @property Center_function    $center_function
 * @property Report_share_data_model $report_share_data_model
 * @property Report_loan_data_model   $report_loan_data_model
 * @property Finance_process_model  $finance_process_model
 * @property Atm_calculator_model   $ATMCalc
 * @property Document   $document
 * @property Loan_calculator_model   $LoanCalc
 * @property Cashier_loan_model   $cashier_loan
 * @property Finance_libraries  $Finance_libraries
 * @property Setting_model      $Setting_model
 * @property Setting_model      $settingModel
 * @property Average_Model      $averageModel
 * @property Deposit_modal      $deposit_modal
 * @property Import_account_transaction $imp_account_trx
 * @property Loan_atm_file      $loan_atm_file
 * @property Installment_Model     $installment
 * @property Return_model     $Return
 * @property Run_import_excel_update $update_st_bl
 * @property Non_pay_model      $NonPay
 * @property Dismiss_model $Dismiss
 * @property Condition_loan_model $condition_model
 * @property Keep $keep
 * @property Loan_model $loan_model
 */
class CI_Controller {
 ...
 * @property Report_share_data_model $report_share_data_model
 * @property Report_loan_data_model   $report_loan_data_model
 * @property Finance_process_model  $finance_process_models
 * @property Atm_calculator_model   $ATMCalc
 * @property Document   $document
 * @property Loan_calculator_model   $LoanCalc
 * @property Cashier_loan_model   $cashier_loan
