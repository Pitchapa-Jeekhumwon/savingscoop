...
function num_format($text) {
    ...
    // print_r($user);
     $filename = $_SERVER["DOCUMENT_ROOT"]."/assets/document/loan/education_loan.pdf" ;
//    $filename    = $_SERVER["DOCUMENT_ROOT"]."/fsccoop/assets/document/loan/education-loan.pdf" ;
    ...
    $money_loan_total_2text  = $this->center_function->convert($data['loan_amount_total']);
    $loan_text               = $this->center_function->convert($data['money_per_period']);//ดอกเบี้ย(ตัวอักษร)
    $loan_text2              = $this->center_function->convert($data['period_amount']);//งวด
    $per_month               = $this->center_function->convert($data['interest_per_year']);//งวด
...
//                $pdf->Image($myImage, 35.5, 185, 3);
                ...
                $pdf->SetXY( 183, $y_point );
                $pdf->MultiCell(9, 5, U2T($month_short_arr[$date_to_month]), $border, "C"); //เดือน
                ...
                $pdf->MultiCell(32, 5, U2T(number_format($data['salary'])), $border, "C"); //รายได้เดือนละ
                $y_point = 84;
                $pdf->SetXY( 80, $y_point );
                $pdf->MultiCell(26, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //ขอกู้เงินจำนวน
                ...
                $pdf->MultiCell(70, 5, U2T(''), $border, "C"); //ชื่อสถานศึกษา
                $pdf->SetXY( 135, $y_point );
                $pdf->MultiCell(60, 5, U2T(''), $border, "C"); //แขวง, ตำบล
                $y_point = 107;
                $pdf->SetXY( 38, $y_point );
                $pdf->MultiCell(76, 5, U2T(''), $border, "C"); //เขต, อำเภอ
                $pdf->SetXY( 127, $y_point );
                $pdf->MultiCell(67, 5, U2T(''), $border, "C"); //จังหวัด
                $y_point = 114.7;
                $pdf->SetXY( 116, $y_point );
                $pdf->MultiCell(78, 5, U2T($position_name), $border, "C"); //จังหวัด
                $y_point = 122.5;
                ...
                $y_point = 137.8;
                $pdf->SetXY( 38, $y_point );
                $pdf->MultiCell(56, 5, U2T($data['amphur_name']), $border, "C"); //เขต, อำเภอ
                ...
                $pdf->MultiCell(24, 5, U2T(number_format($data['money_per_period'])), $border, "C"); //ส่งงวดละ
                $pdf->SetXY( 165.5, $y_point );
                $pdf->MultiCell(20, 5, U2T(number_format($data['period_amount'])), $border, "C"); //งวด
                $y_point = 241.9;
                $pdf->SetXY( 131.3, $y_point );
                $pdf->MultiCell(46, 5, U2T($data['marry_name']), $border, "C"); //ชื่อผู้กู้
                $y_point = 284.8;
                $pdf->SetXY( 125, $y_point );
                $pdf->SetFont('THSarabunNew', '', 12.5 );
                ...
                $pdf->MultiCell(12.5 , 5, U2T($share_group['share_collect_value']), $border, "C");//เงินค่าหุ้น(บาท)
                $pdf->SetFont('THSarabunNew', '', 9 );
                ...
                $pdf->MultiCell(64, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //วันที่
                //$pdf->Image(157, 220, 3); //เคยผิดนัดการส่งเงินงวดชำระหนี้(เคย) -- check box
                //$pdf->Image( 170.5, 220, 3); //เคยผิดนัดการส่งเงินงวดชำระหนี้(ไม่เคย) check box
                $y_point = 226.3;
                $pdf->SetXY( 66.5, $y_point );
                //$pdf->MultiCell(126, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //วันที่
            }else if($pageNo == '3'){
                $y_point = 35.2;
                $pdf->SetXY( 165, $y_point );
                ...
                $pdf->MultiCell(36.5, 5, U2T($data['member_id']), $border, "C"); //ตำแหน่ง
                $y_point = 58.2;
                $pdf->SetXY( 85, $y_point );
                $pdf->MultiCell(55, 5, U2T($data['position_name']), $border, "C"); //สมาชิก
                $y_point = 65.7;
                ...
                $pdf->MultiCell(21, 5, U2T($data['address_no']), $border, "C"); //บ้านเลขที่
                $y_point = 73.5;
                ...
                $pdf->MultiCell(45, 5, U2T($data['province_name']), $border, "C"); //จังหวัด
                $pdf->SetXY( 93, $y_point );
                $pdf->MultiCell(58, 5, U2T($data['mobile']), $border, "C"); //เบอร์โทรศัพท์
                $y_point = 104;
                $pdf->SetXY( 102, $y_point );
                $pdf->MultiCell(27, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //จำนวนเงิน
                $pdf->SetXY( 138, $y_point );
                $pdf->MultiCell(57, 5, U2T($money_loan_amount_2text), $border, "C"); //ตัวอักษร
                $y_point = 119.7;
                $pdf->SetXY( 144, $y_point );
                //$pdf->SetFont('THSarabunNew', '', 10.5);
                $pdf->MultiCell(50, 5, U2T($loan_text), $border, "C"); //จำนวนเงิน
                $y_point = 127;
                $pdf->SetFont('THSarabunNew', '', 14);
                ...
                $pdf->MultiCell(30, 5, U2T($per_month ), $border, "C"); ///จำนวนเงิน
                $y_point = 134.8;
                ...
                $pdf->MultiCell(14, 5, U2T(number_format($share['share_collect_value'])), $border, "C"); //เป็นจำนวนเงิน
                ...
                $pdf->SetXY( 146, $y_point );
                $pdf->MultiCell(27, 5, U2T($month_arr[$date_to_month]), $border, "C"); //วันที่
                ...
                $pdf->MultiCell(34, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //จำนวนเงิน
                $pdf->SetXY( 119, $y_point );
                $pdf->MultiCell(65, 5, U2T($this->center_function->convert($data['loan_amount'])), $border, "C"); //จำนวนเงินตัวเขียน
                $y_point = 113;
                $pdf->SetXY( 40, $y_point );
                $pdf->MultiCell(30, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //จำนวนเงิน
                $pdf->SetXY( 85, $y_point );
                ...
                $y_point = 166.5;
                $pdf->SetXY( 35, $y_point);
                $pdf->MultiCell(56, 5, U2T($data['transfer_type']), $border, "C"); //บัญชีเงินฝากประเภท
                $pdf->SetXY( 107, $y_point);
                $pdf->MultiCell(88, 5, U2T($data['transfer_account_id']), $border, "C"); //เลขที่บัญชี
                $y_point = 197;
                $pdf->SetXY( 87, $y_point);
                $pdf->MultiCell(33, 5, U2T(number_format($data['loan_amount'])), $border, "C"); //กู้เงินจากสหกรณ์จำนวน
                $pdf->SetXY( 142, $y_point);
                $pdf->MultiCell(27, 5, U2T(''), $border, "C"); //คงเหลือ
                $y_point = 243;
                $pdf->SetXY( 80, $y_point);
                $pdf->SetFont('THSarabunNew', '', 12);
                $pdf->MultiCell(60, 5, U2T($fullname_th), $border, "C"); //ลงชื่อรับรอง
            }else if($pageNo == '6'){
                ...
                $pdf->MultiCell(15, 5, U2T($data['c_address_no']), $border, "C"); //บ้านเลขที่(ปัจจุบัน)
                ...
                $pdf->MultiCell(42, 5, U2T(($data['c_address_soi']=='')?'-':$data['c_address_soi']), $border, "C"); //ตรอก,ซอย (ปัจจุบัน)
                $pdf->SetXY( 157.5, $y_point );
                $pdf->MultiCell(38, 5, U2T(($data['c_address_road']=='')?'-':$data['c_address_road']), $border, "C"); // ถนน (ปัจจุบัน)
                $y_point = 71;
                $pdf->SetXY( 40.5, $y_point );
                $pdf->MultiCell(48, 5, U2T($data['district_name']), $border, "C"); // ตำบล(ปัจจุบัน)
                $pdf->SetXY( 106, $y_point );
                $pdf->MultiCell(42, 5, U2T($data['amphur_name']), $border, "C"); // อำเภอ (ปัจจุบัน)
                $pdf->SetXY( 161, $y_point );
                $pdf->MultiCell(35, 5, U2T($data['province_name']), $border, "C"); //จังหวัด(ปัจจุบัน)
                $y_point = 78.5;
                $pdf->SetXY( 49, $y_point );
                $pdf->MultiCell(38, 5, U2T($data['tel']), $border, "C"); // เบอร์โทรศัพท์
                $pdf->SetXY( 100, $y_point );
                $pdf->MultiCell(38, 5, U2T($data['mobile']), $border, "C"); // เบอร์มือถือ
                $pdf->SetXY( 152, $y_point );
                $pdf->MultiCell(43.5, 5, U2T($data['position']), $border, "C"); // ตำแหน่ง
                $y_point = 86.2;
                $pdf->SetXY( 30.5, $y_point );
                $pdf->MultiCell(38, 5, U2T($data['mem_group_name_faction']), $border, "C"); // สังกัด
                $pdf->SetXY( 106.5, $y_point );
                $pdf->MultiCell(20, 5, U2T(number_format($data['salary'], '0', '.', ',')), $border, "C"); // เงินเดือน
                $pdf->SetXY( 135.5, $y_point );
                $pdf->MultiCell(60, 5, U2T($this->center_function->convert($data['salary'])), $border, "C"); // เงินเดือน(ตัวอักษร)
                $y_point = 93.8;
                $pdf->SetXY( 157.5, $y_point );
                $pdf->MultiCell(40, 5, U2T($data['member_id']), $border, "C"); // ทะเบียนสมาชิกเลขที่
                $y_point = 117.5;
                $pdf->SetXY( 64.5, $y_point );
                $pdf->MultiCell(20, 5, U2T($loan['contract_number']), $border, "C"); //สัญญากู้เลขที่..
                $pdf->SetXY( 106, $y_point );
                $pdf->MultiCell(20, 5, U2T($loan['petition_number']), $border, "C"); // คำขอกู้เลขที่
                $y_point = 243.5;
                $pdf->SetXY( 85, $y_point );
                $pdf->SetFont('THSarabunNew', '', 13);
                ...
                $pdf->MultiCell(33, 5, U2T($month_arr[$date_to_month]), $border, "C"); //วันที่
                ...
                $pdf->SetXY( 129, $y_point );
                $pdf->MultiCell(64, 5, U2T($data['position']), $border, "C"); //ชื่อ...
                $y_point = 95.8;
                $pdf->SetXY( 41, $y_point);
                //$pdf->SetFont('THSarabunNew', '', 10);
                $pdf->MultiCell(64, 5, U2T($data['mem_group_name_faction']), $border, "C"); //ชื่อ...
                $pdf->SetXY(110, $y_point );
                $pdf->SetFont('THSarabunNew', '', 10 );
                $pdf->MultiCell(60, 5, U2T($data['mem_group_name_level']), $border, "C"); //ชื่อ...
                $y_point = 111;
                $pdf->SetFont('THSarabunNew', '', 13 );
                $pdf->SetXY( 35.5, $y_point );
                $pdf->MultiCell(23, 5, U2T(number_format($data['salary'])), $border, "C"); //เงินเดือน
                $pdf->SetXY( 69, $y_point );
                $pdf->MultiCell(66, 5, U2T($this->center_function->convert($data['salary'])), $border, "C"); //เงินเดือน(ตัวอักษร)
                $pdf->SetXY( 159, $y_point );
                $pdf->MultiCell(38, 5, U2T($month_arr[$data['month_start']]), $border, "C"); //ในเดือน....มีเงินคงเหลือ
                $y_point = 118.7;
                $pdf->SetXY( 51, $y_point );
                $pdf->MultiCell(40, 5, U2T(number_format($data['salary']-$data['money_per_period'], 2)), $border, "C"); //
                $pdf->SetXY( 102, $y_point );
                $pdf->MultiCell(90, 5, U2T($this->center_function->convert($data['salary']-$data['money_per_period'])), $border, "C"); //
            }
    }
