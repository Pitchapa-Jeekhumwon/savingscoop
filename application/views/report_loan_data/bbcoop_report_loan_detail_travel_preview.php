...
<div style="width: 1000px" class="page-break">
    <div class="panel panel-body flex-box" style="!important; height: 1400px;">
        <div class="title">
            แบบรายงานรายละเอียดการยื่นกู้เพื่อการท่องเที่ยว
        </div>
        ...
        <div class="content-middle">
            ...
            <div class="list-condition-block">
                ...
                <div class="txt-line-detail"> [<?php echo @$prev_loan_type_count < $max_contract_total ? '/' : '&nbsp;'?>] สมาชิกกู้เงินท่องเที่ยวได้ไม่เกินคนละ <?php echo $max_contract_total;?> สัญญา</div>
                <div class="txt-line-detail"> [/] เงินกู้สำหรับตนเอง บุคคลในครอบครัวหรือผู้ติดตามไม่เกิน 3 รายๆ ละไม่เกิน 50,000 บาท รวมไม่เกิน 150,000 บาท</div>
                <div class="txt-line-detail"> [<?php echo $row_loan['period_amount'] <= $max_period ? '/' : '&nbsp;'?>] ผ่อนไม่เกิน <?php echo $max_period;?> งวด</div>
