                                    ...
                                    foreach (@$income as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="inline_income" style="text-align:right;">
                                                <span class="inline_income"
                                                      data-text="<?= $value['id'] ?>"><?php echo (@$value['income_value'] == 0) ? "-" : number_format(@$value['income_value'], 2); ?></span>
                                            </td>
                                        </tr>
                                        <?php
                                    }
					...
					<tr>
						...
						<td style="height: 150px;border-left: 0px;padding-top: 10px;padding-bottom: 10px;">
								...
								<table  class="no-border">
									...
									<tr>
										<td>
                                            <?php if(!empty(@$row_real_estate['real_estate_position_1']) || !empty(@$row_real_estate['real_estate_position_2'])){?>
											ระวาง
										...
										<td>เลขที่ <?php echo @$row_real_estate['land_number'];?></td>
