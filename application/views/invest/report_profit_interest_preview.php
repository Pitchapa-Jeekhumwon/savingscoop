            ...
            <div style="width: 8.3in;" class="page-break">
                <div class="panel panel-body" style="padding-top:10px !important;height: 11.7in;">
                    ...
                    if ($prev_id != $data['id']) {
                        ...
                        ?>
                        <table class="table"
                               style="<?php echo $index != 0 && $str_f == 0 ? 'margin-top: 100px;' : ''; ?> width:90%; margin-bottom: 10px;">
                            <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th style="border: unset;width: 25%;" class="text-left">
                                    วันที่ลงทุน
                                    : <?php echo $this->center_function->ConvertToThaiDate($data['invest_date'], '1', '0'); ?>
                                </th>
                                <th style="border: unset;width: 30%;" class="text-left">
                                    วันที่ครบกำหนด
                                    : <?php echo $this->center_function->ConvertToThaiDate($data['end_date'], '1', '0'); ?>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th style="border: unset;" class="text-left">
                                    สถานะ
                                    : <?php echo $data['status'] == 1 && strtotime($data['end_date']) >= strtotime(date("Y-m-d")) ? "ปกติ"
                        ...
                        <table class="table" style="width:80%; margin-top: 10px;">
                            ...
                            <tr>
                                ...
                                <th style="width: 15%;vertical-align: middle;"
                                    class="text-right"><?php echo number_format($total, 2); ?></th>
