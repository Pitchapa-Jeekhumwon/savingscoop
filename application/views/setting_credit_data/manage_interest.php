		...
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				<div class="panel panel-body">
					...
					<form id='form_save' action="<?php echo base_url(PROJECTPATH.'/setting_credit_data/save_manage_interest?id='.@$_GET['id']); ?>" method="post" data-toggle="validator" novalidate="novalidate" >	
            ...
            <?php
              ...
              foreach ($main_condition as $key_main => $value_main) {
                ...
                ?>
                          ...
                          <div class="row" data-form="1">
                            ...
                            <div class="col-sm-2">
                              <div class="col-sm-6 text-right">
                                <button style="font-size:16px;width: fit-content;padding-top: 5px;<?=($is_last==false ? "display: none;" : "")?>" class="btn btn-primary btn-block plus" data-btn="<?=($key_main+1)?>" data-tag="home<?=($key_main+1)?>" type="button"><i class="fa fa-plus"></i></button>
                              </div>
                              <div class="col-sm-6 text-left">
                                <button style="font-size:16px;width: fit-content;padding-top: 5px;" class="btn btn-danger btn-block minus" data-btn="<?=($key_main+1)?>" data-tag="home<?=($key_main+1)?>" type="button"><i class="fa fa-minus"></i></button>
                              </div>
                            </div>
                          </div>
                        <?php
                  ...
                  <br>
                  <div class="row">
                      <label class="col-sm-2 control-label text-right" >ผลลัพท์</label>
                      <div class="col-sm-3">
              ...
              <div id="home1" class="tab-pane fade in active">
                ...
                <div id="home1_condition">
                  <div class="row" data-form="1">
                    ...
                    <div class="col-sm-2">
                      <div class="col-sm-6 text-right">
                        <button style="font-size:16px;width: fit-content;padding-top: 5px;" class="btn btn-primary btn-block plus" data-btn="1" data-tag="home1" type="button"><i class="fa fa-plus"></i></button>
                      </div>
                      <div class="col-sm-6 text-left">
                        <button style="font-size:16px;width: fit-content;padding-top: 5px;display: none;" class="btn btn-danger btn-block minus" data-btn="1" data-tag="home1" type="button"><i class="fa fa-minus"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  ...
  var template_garantor = `<div id="home1_garantor">
                  <div class="row" data-form="1">
                    ...
                    <div class="col-sm-2">
                      <div class="col-sm-6 text-right">
                        <button style="font-size:16px;width: fit-content;padding-top: 5px;" class="btn btn-primary btn-block plus-garantor" data-btn="1" data-tag="home1" type="button"><i class="fa fa-plus"></i></button>
                      </div>
                      <div class="col-sm-6 text-left">
                        <button style="font-size:16px;width: fit-content;padding-top: 5px;display: none;" class="btn btn-danger btn-block minus-garantor" data-btn="1" data-tag="home1" type="button"><i class="fa fa-minus"></i></button>
                      </div>
                    </div>
                  </div>
                </div>`;
  ...
  function submit_form(){
    ...
    $.ajax({
				method: 'POST',
				url: base_url+'Setting_credit_data/check_have_global_interest_rate',
				data: {
				...
				success: function(data){
					//console.log(data);
					if(data.result==true){//มีเรทดอกเบี้ย ในตารางหลัก เซิฟทับหรือไม่
						
            swal({
                title: "ต้องการดำเนินการต่อหรือไม่?",
                text: "มีการกำหนดเรทดอกเบี้ย ในระบบตั้งค่าหลักแล้ว \r\nต้องการบันทึกเรทดอกเบี้ยใหม่นี้หรือไม่ ?",
                type: "warning",
            ...
            function(isConfirm){
              ...
              if (isConfirm){
                swal("บันทึก!", "โปรดรอ การบันทึกเรทดอกเบี้ย", "success");
                setTimeout(() => {
                  // alert("save");
                  $('#form_save').submit();
                }, 3000);
              } else {
                swal("ยกเลิก", "ยกเลิกการบันทึกเรทดอกเบี้ย", "error");
                    // e.preventDefault();
              }
            });
