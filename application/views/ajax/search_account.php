		...
		?>
			<tr>
				...
				<td>
					...
					<a onclick="add_account('<?php echo @$row["account_id"];?>','<?php echo $row['mem_id']; ?>','<?php echo $row['type_id']; ?>')" style="cursor:pointer;"> แก้ไข </a> |
					<a class="text-del" onclick="close_account('<?php echo @$row["account_id"];?>')">ปิดบัญชี</a>
					<?php } ?>
				</td>
			</tr>
		<?php 
