        ...
        <div class="row gutter-xs">
            <div class="col-xs-12 col-md-12">
                <div class="panel panel-body" style="padding-top:0px !important;">
                    <br>
                    <form action="<?=base_url('setting_saving_slip/save_coop_saving_slip_style_setting?style_id='.$_GET['style_id'])?>" method="POST">
                    <div class="row">
