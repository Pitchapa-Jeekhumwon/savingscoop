											...
											<table class="table table-bordered table-striped table-center">
												<thead> 
													<tr class="bg-primary">
                                                        ...
                                                        <th rowspan="2" style="vertical-align: middle;">ดอกเบี้ยสะสม</th>
													...
													<tr class="bg-primary">
														<th style="vertical-align: middle;width: 77px;">เลขสมาชิก</th>
														<th style="vertical-align: middle;width: 218px;">ชื่อ-สกุล</th>
														<th style="vertical-align: middle;width: 120px;">วงเงินค้ำประกัน</th>
													</tr>
												</thead>
												<tbody>
												<?php
												...
												?>
													<tr> 
														...
														<td>
														<?php 
															$petition_number = "<a href='".base_url(PROJECTPATH.'/'.@$row_loan['petition_file'].'/'.$row_loan['id'])."' target='_blank'>".$row_loan['petition_number']."</a>";
														...
														<td class="text-right"><?php echo number_format(@$accumulated_interest['loan'][$row_loan['id']]['return_amount'], 2);?></td>
														...
														<td style="vertical-align: top; padding: unset;" colspan="3">
                                                            <div style="width: 100%;">
															<table class="table table-responsive table-bordered table-striped" style="margin:-1px; font-size: 0.9em; overflow-x: hidden">
                                                            <?php
                                                            ...
                                                            ?>
                                                                <tr >
                                                                    ...
                                                                    <td class="text-left" style="vertical-align: top; width: 221px !important;">
                                                                        <?php echo @$row_guarantee_loan['prename_full'].@$row_guarantee_loan['firstname_th'].'  '.@$row_guarantee_loan['lastname_th'];?>
                                                                    </td>
                                                                    <td class="text-left" style="vertical-align: top; text-align: right !important; width: 120px !important; ">
                                                                        <?php echo number_format(@$row_guarantee_loan['guarantee_person_amount'], 2);?>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                                }
										...
										<div class="bs-example" data-example-id="striped-table">
											<table class="table table-bordered table-striped table-center">
												<thead> 
													<tr class="bg-primary">
														<th width="5%">#</th>
														<th width="12%">วันที่ทำรายการ</th>
														<th width="12%">เลขที่คำร้อง/เลขที่สัญญา</th>
														<th width="12%">วงเงินกู้</th>
														<th width="12%">วงกู้คงเหลือ</th>
														<th width="12%">ยอดหนี้คงเหลือ</th>
														<th width="12%">ดอกเบี้ยสะสม</th>
												...
												<?php if(!empty($row_loan_atm_all)){ $i=1; ?>
													<?php foreach($row_loan_atm_all as $key => $value){ ?>
														<tr>
															...
															<td class="text-right"><?php echo number_format(@$accumulated_interest['atm'][$value['loan_atm_id']]['return_amount'], 2); ?></td>
											...
											<table class="table table-bordered table-striped table-center">
												...
												?>
													<tr> 
														...
														<td><?php echo number_format($row_guarantee['guarantee_person_amount'],2); ?></td>
														<td><?php echo number_format($row_guarantee['guarantee_person_amount_balance'],2); ?></td>
													</tr>
													<?php }
													}else{ ?>
													...
													<tr> 
														...
														<td>
															<?php
																...
																?>
																	<a href="<?php echo base_url(PROJECTPATH.'/admin/receipt_form_pdf/'.jwt::urlsafeB64Encode($this->center_function->encrypt_text(@$receipt['receipt_id']))); ?>" target="_blank" <?=$is_void?> title="<?=$title ?>"><?php echo @$receipt['receipt_id'];?></a>
																	<br>
																<?php 
																	}
																}
										...
										?>
											<tr>
												...
												<td>
													...
													<a href="<?php echo base_url(PROJECTPATH.'/admin/receipt_form_pdf/'.jwt::urlsafeB64Encode($this->center_function->encrypt_text($transaction['receipt_id']))); ?>" target="_blank"><?php echo $transaction['receipt_id'];?></a>
													<?php } ?>
												</td>
